...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.9d822f72117bfe1bbc960044b8e3ecde7fb0250ed7a916eaed9ae2b33a596289.js',function(){input.required=false;search();});}
