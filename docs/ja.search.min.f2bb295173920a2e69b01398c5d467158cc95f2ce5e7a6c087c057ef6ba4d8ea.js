...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ja.search-data.min.15a5f94f2e38ad4a7dd3d9f4cfb47cf4ddd0d1b60495a84ce67f54ee38c45337.js',function(){input.required=false;search();});}
